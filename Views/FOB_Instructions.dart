...
import 'package:navapp/Views/FOB_Lecture_Halls.dart';
...
class FOB_Instructions extends StatelessWidget {
  const FOB_Instructions({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("FOB Locations"),
      ),
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) =>  const FOB_Lecture_Halls(),
                  ),
                );
              },
              child: const Text(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const FOB_Study_Rooms(),
                  ),
                );
              },
              child: const Text(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const FOB_Open_Area(),
                  ),
                );
              },
              child: const Text(
