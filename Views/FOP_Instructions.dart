...
import 'package:navapp/Views/FOP_Lecture_Halls.dart';
import 'package:navapp/Views/OfficeRooms.dart';
import 'package:navapp/Views/RestRooms.dart';


class FOP_Instructions extends StatelessWidget {
  const FOP_Instructions({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("FOP Locations"),
      ),
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) =>  const FOP_Lecture_Halls(),
                  ),
                );
              },
              child: const Text(
